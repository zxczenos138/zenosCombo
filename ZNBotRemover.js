        ...
        if (!next) {
            ...
            for (var i = 0; i < playerList.size(); ++i) {
                ...
                if (speed != undefined && speed != NaN && isBot(entity, speed)) {
                    ...
                    Chat.print("§8[§9§lZNBotRemover§8] §3操你妈,你个Matrix小假人被我抓住了吧 §a" + entity.getName() + "§3.");
                }
            }
...
var znBotRemoverModule = new ZNBotRemoverModule();

function onEnable() {
    moduleManager.registerModule(znBotRemoverModule);
}

function onDisable() {
    moduleManager.unregisterModule(znBotRemoverModule);
}
