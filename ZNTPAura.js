...
var scriptName = "ZNTPAura";
var scriptVersion = 3.1;
var scriptAuthor = "zxczenos138";
var ZNTPAura = /** @class */ (function () {
    function ZNTPAura() {
        this.setting = {
    ...
    ZNTPAura.prototype.getName = function () {
        return "VanillaTPAura";
    };
    ZNTPAura.prototype.getDescription = function () {
        return "VanillaTPAura-Module, By-mumy";
    };
    ZNTPAura.prototype.getCategory = function () {
        return "Misc";
    };
    ZNTPAura.prototype.onEnable = function () {
        this.targetList = [];
        this.prevTargetTable.clear();
        this.renderPath = [];
    };
    ZNTPAura.prototype.onDisable = function () {
        this.onEnable();
    };
    ZNTPAura.prototype.onMotion = function (event) {
    ...
    ZNTPAura.prototype.onRender3D = function (event) {
    ...
    ZNTPAura.prototype.onWorld = function (event) {
        moduleManager.getModule(this.getName()).setState(false);
    };
    ZNTPAura.prototype.addValues = function (values) {
        var settings = this.settings;
        for (var key in settings) {
            values.add(settings[key]);
        }
    };
    ZNTPAura.prototype.updateTarget = function () {
        this.targetList = [];
    ...
    ZNTPAura.prototype.isEnemy = function (entity) {
    ...
    ZNTPAura.prototype.runAttack = function () {
    ...
    ZNTPAura.prototype.teleportAttackEntity = function (entity) {
        var player = mc.thePlayer;
        if (player.getDistanceToEntity(entity) < 3) {
            this.attackEntity(entity);
            return true;
        }
        var path = new ZNTPAura.FindPath(new ZNTPAura.DynamicPos(function () { return player.posX; }, function () { return player.posY; }, function () { return player.posZ; }), new ZNTPAura.DynamicPos(function () { return entity.posX; }, function () { return player.posY; }, function () { return entity.posZ; }), 0).getPath();
        if (path == null) {
            return false;
        }
        ...
        var gotoPath = ZNTPAura.FindPath.Utils.simplifyPath(path, this.settings.packetsDistance.get());
        this.renderPath = [];
        ...
        this.renderPath.push(new ZNTPAura.Pos(lastX, Math.floor(entity.posY), lastZ));
        ...
        var backPath = ZNTPAura.FindPath.Utils.simplifyPath(path.reverse(), this.settings.packetsDistance.get());
    ...
    ZNTPAura.prototype.attackEntity = function (entity) {
        var player = mc.thePlayer;
        var netHandler = mc.getNetHandler();
    ...
    ZNTPAura.prototype.drawBox = function (x, y, z, color) {
    ...
    ZNTPAura.DynamicPos = /** @class */ (function () {
    ...
    ZNTPAura.FindPath = (_a = /** @class */ (function () {
...
function onLoad() { }
function onEnable() {
    scriptModule = moduleManager.registerModule(new ZNTPAura());
}
function onDisable() {
