...
function AutoGapple() {
  ...
  var Delay = value.createInteger("CustomDelay", 15, 0.0, 1.3;
  var packetY = value.createFloat("CustomPacketY", 0.5, 0.0, 0.66;
  var hurttime = value.createFloat("HurtTime", 10, 0.0, 20;
