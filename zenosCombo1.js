var skriptName = "zenosCombo1";
var skriptVersion = 3.1;
...
function zenosCombo1() {
  ...
  var settings = {
	Mode: setting.list("Mode", ["Matrix", "NPC", "Spartan" , "Matrix2", "zenos", "zenka-TPHop"], "Matrix"),
...
if(event.getTargetEntity() instanceof EntityPlayer){
          ...
          break;
		      case "zenos": // tried to remake what flux has as "Hypixel" mode but i think this is patched on Hypixel
	    	  shit++;
		          if(shit == 1) { 
